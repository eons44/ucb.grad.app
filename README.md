...
## Summary of Qualities Presented

### **Technical and Research Skills**
- **Molecular Biology and Lab Techniques**:
  - Vector and primer design
  ...
  - Cloning and transformation
    ...
    - tobacco
  - Greenhouse management (pest control, seed harvesting, plant care)
  - Transgenic screening techniques
    - leaf painting
    - seed plating
    - zygosity analysis
  - Fatty Acid Methyl Ester (FAME) gas chromatography analysis
  - Western blotting
  - Nile red staining & fluorescence spectroscopy
- **Bioinformatics and Data Analysis**:
  - Developed and refined bioinformatics pipelines
  - Automated FAME GC analysis using software to streamline data collection
  - OpenCV-based image quantification
  - Genomic data processing
- **Software Engineering and Development**:
  - Co-founded Brain2Bot, specializing in “natural intelligence” software inspired by Drosophila and C. elegans neuronal behavior
  - Developed cloud-based solutions for remote collaboration and data sharing
  - Built an open-source framework for biomimicry and a simplified programming language, Elder
  - Website development and management, emphasizing accessibility
...
- **Teaching Experience**:
  - Transitioned from student to TA in bioinformatics seminar, assisting peers with course content
  - Provided guidance and mentoring to undergraduates in lab techniques and best practices
  - Provided guidance and mentoring on western blotting to grad students
  - Mentored other engineers as a senior software engineer, focusing on collaboration and skill development
- **Mentorship**:
  - Assisted grad students with technical support on genomics, image quantification, and software issues
  - Known for making complex scientific and computational concepts accessible to a range of students and colleagues

### **Leadership and Initiative**
- **Entrepreneurial Skills**:
  - Co-founded Brain2Bot
  - Formed the Reno Video Game Symphony as a 501(c)(3) non-profit, served on the board, gaining business experience and legal knowledge, and demonstrating commitment to community initiatives
- **Innovation and Problem Solving**:
  - Independently created cloud-based data-sharing architecture for remote lab collaboration
  - Proactively improved lab equipment
    - refurbishing growth chambers
    - creating monitoring modules
  - Identified and implemented workflow improvements, including automated systems and optimized data protocols

### **Interpersonal and Character Traits**
- **Community-Centric Mindset**:
  - Actively contributed to his community through roles in 
    - The National Honor Society
    - Amateur Radio Emergency Services
    - The Reno Philharmonic Youth Concert Orchestra
  - Committed to “uplifting the community and encouraging a spirit of inclusion,” especially in mental health advocacy
  - Provided web development and data-sharing resources for Indigenous groups to aid in global advocacy
- **Diversity and Inclusion**:
  - Advocates for gender diversity based on personal experience in male-dominated fields
  - Experienced team success due to a balanced gender representation in software engineering teams, music ensembles, and lab groups
- **Mental Health Advocacy**:
  - Prioritizes mental health awareness and support, especially among peers and students
  - Has a personal commitment to regularly check in with colleagues and friends to ensure they feel seen and appreciated

### **Intellectual Curiosity and Drive**
- **Passion for Learning and Interdisciplinary Exploration**:
  - Self-taught programmer in C++ and other technical skills; driven by curiosity in both computer science and biochemistry
  - Seeks to bridge technology and biology, using biomimetic frameworks to address complex biological questions
  - Passion for achieving a “people-first, community-centered mindset” in scientific and technological advancement
- **Long-Term Vision and Commitment to Science**:
  - Goal to extend human healthspan through advanced biochemistry and molecular biology
  - Motivated by a long-term vision of societal advancement and environmental sustainability
  - Believes in lifelong learning and sees a Ph.D. as essential for achieving his goals of integrating biotechnology and artificial intelligence
